<div class="container-2">
	<h4 class="center underline">Kelola Surat Izin Penelitian</h4>
</div>
<form action="">
	<div class="row flex">
		<div class="col l6 m6">
			<a class="waves-effect waves-light btn" href="<?= BASE_URL."form_surat_keluar_izin_penelitian" ?>">Buat Surat</a>
		</div>
		<div class="col l5 m5">
